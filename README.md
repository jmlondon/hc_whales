> This manuscript is being developed within RStudio using the knitr package and the R-Markdown format
...
The `hc_whales.md` file provides a relatively recent view of the entire document. Note the latex equations are not properly interpretted by GitHub's markdown interpreter. View the `hc_whales.html` in browser for a complete version. The `hc_whales.md` file can also be converted to MS Word (.docx) format using pandoc in the terminal:

`pandoc -s -S hc_whales.md -o hc_whales.docx`
