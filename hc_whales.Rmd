...
```{r,echo=FALSE,fig.cap=fn("Frequency distribution of model outputs from the bio-energetic Monte Carlo simulation for the 2003 and 2005 killer whale incursions"),warning=FALSE,message=FALSE}
