...
`r tn("Parameter values and distributions used in the Monte Carlo simulation of killer whale consumption of harbor seals in Hood Canal, Washington.")`
...
`r tn("AIC values from four GLMs evaluating hypotheses of harbor seal population response to killer whale predation in Hood Canal, Washington.")`
...
`r tn("Calorimetric values determined from whole body harbor seal carcasses recovered in Washington State.")`
...
```{r mc-density-plot,echo=FALSE,fig.cap=fn("Frequency distribution of model outputs from the bio-energetic Monte Carlo simulation for the 2003 and 2005 killer whale incursions"),warning=FALSE,message=FALSE}
